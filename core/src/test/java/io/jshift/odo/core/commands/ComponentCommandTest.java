...
public class ComponentCommandTest {
    ...
    public void should_execute_link_command() {
        ...
        assertThat(cliCommand)
            .containsExactlyInAnyOrder(CommandTransformer.transform("component link backend --component frontend"));
    ...
    public void should_create_unlink_command() {
        ...
        assertThat(cliCommand)
            .containsExactlyInAnyOrder(CommandTransformer.transform("component unlink backend"));
    }
    ...
    public void shouldExecuteUpdateProjectCommand() {
        ...
        assertThat(cliCommand)
            .containsExactlyInAnyOrder(CommandTransformer.transform("component update mycomponent --project myproject"));
    ...
    public void shouldExecuteUpdateAppCommand() {
        ...
        assertThat(cliCommand).containsExactlyInAnyOrder(CommandTransformer.transform("component update mycomponent --app myapp"));
    }
    ...
    public void shouldExecuteUpdateBinaryCommand() {
        ...
        assertThat(cliCommand).containsExactlyInAnyOrder(CommandTransformer.transform("component update mycomponent --binary ./target/bin"));
    }
    ...
    public void shouldExecuteUpdateRefCommand() {
        ...
        assertThat(cliCommand).containsExactlyInAnyOrder(CommandTransformer.transform("component update mycomponent --ref testrefname"));
    }
    ...
    public void shouldExecuteUpdateGitCommand() {
        ...
        assertThat(cliCommand).containsExactlyInAnyOrder(CommandTransformer.transform("component update mycomponent --git git-url"));
    }
    ...
    public void shouldExecuteUpdateLocalCommand() {
        ...
        assertThat(cliCommand).containsExactlyInAnyOrder(CommandTransformer.transform("component update mycomponent --local ./target/dir"));
    }
